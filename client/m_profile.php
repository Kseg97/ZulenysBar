        ...
        <div class="card-panel grey darken-4 white-text">
            <div class="row">
                ...
                <div class="col s7 offset-s1">
                    ...
                    <br>
                    <!-- Modal Trigger -->
                    <a class="waves-effect lime waves-black btn modal-trigger black-text" href="#m_modal_profile">CAMBIAR CONTRASEÑA</a>
                </div>
            </div>
        </div>
    </div>
...
<!-- Modal Structure -->
<div id="m_modal_profile" class="modal bottom-sheet">
        ...
        <form action="update_password.php" method="post">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input id="m_old_pswd" name="old_pswd" type="password" class="validate" required>
                    <label for="m_old_pswd">CONTRASEÑA ACTUAL</label>
                </div>
                <div class="input-field col s6">
                    <input id="m_new_pswd" name="new_pswd" type="password" class="validate" required>
                    <label for="m_new_pswd">CONTRAEÑA NUEVA</label>
                </div>
