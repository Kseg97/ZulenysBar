        ...
        <div class="col s12">
            ...
            <div class="card grey darken-4">
                <div class="card-tabs">
                    ...
                    <li class="tab col s2"><a class="active" href="#m_list_song" class="">Lista de canciones</a></li>
                    <li class="tab col s2"><a href="#m_new_song">Agregar cancion</a></li>
                    <li class="tab col s2"><a href="#m_new_genre">Agregar género</a></li>
                    <li class="indicator" style="left: 85px; right: 85px;"></li></ul>
                </div>
                <div class="card-content grey darken-3 grey-text text-lighten-3">
                    <div id="m_list_song" class="active" style="display: block;">
<!--Lista Canciones (RUD) -->
...
<!--Fin-->
                    ...
                    <div id="m_new_song" style="display: block;">
    <!--añadir cancion (C) -->                        
                        <div class="row">
...
<!--Fin-->
                    ...
                    <div id="m_new_genre" style="display: block;">
    <!--añadir genero (C) -->                        
                        <div class="row">
                            <form method="POST" action="admin.php?tab=3">
                                ...
                                <div class="col s12">
                                    <button class="btn right waves-effect waves-light btn-small lime black-text" type="submit" style="margin-top: 15px;">Agregar</button>
                                </div>
                            </form>
                        </div>
<!--Fin-->
