            ...
            <div class="card grey darken-4">
                <div class="card-tabs">
                    <ul class="tabs tabs-fixed-width tabs-transparent">
                        <li class="tab"><a href="#m_drinks_request" >Pedidos</a></li>
                        <li class="tab"><a href="#m_drinks_crud">Agregar</a></li>
                        <li class="tab"><a href="#m_drinks_list">Administración</a></li>
