...
<!--REPORTS (TEMPERATURE)-->
            <div class="row" style="">
                <div class="col s10 offset-s1 " style="">
                    <div id="chartHistory" style="height: 370px; max-width: 80vw; position: absolute; margin: auto; top: 0; right: 0; bottom: 0; left: 0;"></div>
                </div>
                <form class="col s8 offset-s2" method="POST" action="admin.php?tab=4">
                    <div class="grey darken-4 input-field col s9">
                    ...
                    <div class="col s3 right-align" style="padding-top:15px;">
...
<!--REPORTS (MUSIC Genre/Song)-->
            <div class="row" style="">
                <div class="col s10 offset-s1 " style="">
                    <div id="chartMusicGenre" style="height: 370px; max-width: 80vw; position: absolute; margin: auto; top: 0; right: 0; bottom: 0; left: 0;"></div>
                </div>
            </div>
<!--END-->
        </div>
...
<!--END-->
    ...
    <script type="text/javascript">  
        $(window).on("load",function(){ 
            ...
            var carousel = $('.carousel.carousel-slider').carousel({fullWidth: true});
            ...
            var chart2 = new CanvasJS.Chart("chartMusicGenre", {
